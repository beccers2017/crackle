 ...
 * @param hashType [description]
 */
void DictionaryAttack::launchDictionaryAttack(std::string filename, std::string hashType) {
	std::string line;
	int lineCount = 0;
...
void DictionaryAttack::calculateHash_MD5(std::string input) {
...
void DictionaryAttack::calculateHash_SHA1(std::string input) {
...
void DictionaryAttack::calculateHash_SHA256(std::string input) {
	unsigned char digest[SHA_DIGEST_LENGTH];
	const char* std::string str = input.c_str();
...
void DictionaryAttack::calculateHash_SHA512(std::string input) {
	unsigned char digest[SHA_DIGEST_LENGTH];
	const char* std::string str = input.c_str();
 ...
 */
bool DictionaryAttack::compareHashes(std::DictionaryHash) {
